...
class ProfileScreen(Screen):
    ...
    def create_profile_func(self, profilename):
        ...
        #cd = CollectData((os.getcwd()+'//UsersData//'),'Maqsood_Ahmed')
        #cd.data_acq()
...
class TrainScreen(Screen):
    ...
    def change_lbl3(self):
        self.lbl3.color = 0.32941176470588235,0.9803921568627451,0.25882352941176473,0.93
